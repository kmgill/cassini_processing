...
class TestIsis3Utils(unittest.TestCase):
    ...
    def test_output_filename_from_label(self):
        assert utils.output_filename_from_label(TestIsis3Utils.LBL_FILE) == "tests/data/N1489034146_ENCELADUS_CL1_IR3_2005-03-09_04.09.10"

    def test_output_tiff_from_label(self):
        assert utils.output_tiff_from_label(TestIsis3Utils.LBL_FILE) == TestIsis3Utils.TIF_FILE

    def test_output_cub_from_label(self):
        assert utils.output_cub_from_label(TestIsis3Utils.LBL_FILE) == TestIsis3Utils.CUB_FILE
